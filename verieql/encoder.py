...
from verieql.context import Context, GroupbyContext
from verieql.errors import *
from verieql.formulas.columns import *
from verieql.formulas.expressions import *
from verieql.formulas.tuples import *
            ...
            if is_cross_join(join_query):
                ...
                # elif 'using' in join_query[1]:
                    ...
                    if 'using' in join_query[1]:
                        ...
                        # natural outer join
                        from verieql.formulas.tables.join_tables._utils import _find_overlapping_attributes
    ...
    def _replace_clause(self, clauses, ctx: Context, group_by=False, having=False, order_by=False, **kwargs):
        ...
        if group_by:
            ...
            def _simplify_having_clause(having_clause):
                ...
                from verieql.formulas.expressions import FExpression
