...
from verieql.formulas.columns.base_column import FBaseColumn
from verieql.formulas.expressions.expression_tuple import FExpressionTuple
from verieql.formulas.expressions.null import FNull
...
class FAttribute(FBaseColumn):
    ...
    def __eq__(self, other):
        from verieql.visitors.interm_function import IntermFunc
    ...
    def __expr__(self, src_tuples, **kwargs):
        from verieql.formulas.columns.aggregations import AggregationType
        from verieql.formulas.expressions.expression import FExpression
        from verieql.formulas.expressions.predicates.case_predicate import FCasePredicate
        from verieql.formulas.expressions.predicates.last_value_predicate import FLastValuePredicate
        from verieql.formulas.expressions.digits import FDigits
