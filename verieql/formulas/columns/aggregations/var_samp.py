...
@register_formula('agg_var_samp')
class FVarSamp(FAggregation):
    def __init__(self, scope, function: str, expression: FBaseExpression = None, **kwargs):
        super(FVarSamp, self).__init__(scope, function, expression, **kwargs)

    def __expr__(self, y_s, group_func=None, **kwargs):
        # STDDEV_POP(constant) => 0, STDDEV_POP(id) => (i - mean)^2/N
