...
from verieql.formulas.tuples.projection_pity_tuple import FProjectionPityTuple
from verieql.formulas.tuples.projection_tuple import FProjectionTuple
...
def _projection(
    ...
    from verieql.formulas.tables.groupby_tables.groupby_table import FGroupByTable
