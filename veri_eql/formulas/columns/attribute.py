...
from veri_eql.formulas.expressions.null import FNull
...
class FAttribute(FBaseColumn):
    ...
    def __eq__(self, other):
        from veri_eql.visitors.interm_function import IntermFunc
    ...
    def __expr__(self, src_tuples, **kwargs):
        from veri_eql.formulas.columns.aggregations import AggregationType
        from veri_eql.formulas.expressions.expression import FExpression
        from veri_eql.formulas.expressions.predicates.case_predicate import FCasePredicate
        from veri_eql.formulas.expressions.predicates.last_value_predicate import FLastValuePredicate
